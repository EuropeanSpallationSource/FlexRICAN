...
"""
================================================================================
 AHU_10 - Air Handling Unit Control (Python soft-PLC)
          group "FreshAir_Wather_Heat_Cool"
================================================================================
 Functional alternative to the licensed CoDeSys 3.5 ST program (AHU_10.st),
 mirroring the same logic on a 200 ms cycle.

 Source : 10ahus_selection_AHU10.json  (project "10AHUs")

 Unit type: fresh-air supply unit with WATER HEATING + COOLING.
   One supply VFD fan (constant volume), a fresh-air intake damper and an
   exhaust/relief damper (both modulating, fail-closed), a water heating coil
   (3-way) with frost protection + pump, and a cooling coil (2-way).
   No heat recovery, no exhaust fan, no humidity control, no damper interlock.
   Temperature is held by a cascade with split-range heat/cool.
================================================================================
"""
...
class PlantSimulator:
    t_outdoor: float = 5.0           # fresh-air intake temperature
    t_supply: float = 16.0
    t_room: float = 20.0
    ...
    def step(self, io: IOImage, dt_s: float) -> None:
        ...
        # supply air = outdoor air conditioned by the coils
...
if __name__ == "__main__":
    print("AHU_10 (FreshAir_Wather_Heat_Cool) soft-PLC starting "
